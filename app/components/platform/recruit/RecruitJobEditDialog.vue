...
<template>
  <v-dialog v-model="modelValue" max-width="760" retain-focus>
    <v-card rounded="xl">
      ...
      <v-card-text class="px-6 pb-0">
        ...
        <v-row>
          ...
          <v-col cols="12" md="4"><v-text-field v-model.number="form.matchScore" type="number" min="0" max="100" label="Match score" variant="outlined" density="compact" /></v-col>
          <v-col cols="12"><v-textarea v-model="form.summary" label="Summary" rows="3" auto-grow variant="outlined" density="compact" /></v-col>
          <v-col cols="12" md="6"><v-text-field v-model="form.missionTitle" label="Mission title" variant="outlined" density="compact" /></v-col>
          <v-col cols="12" md="6"><v-textarea v-model="form.missionDescription" label="Mission description" rows="3" auto-grow variant="outlined" density="compact" /></v-col>
          <v-col cols="12" md="4"><v-textarea v-model="form.responsibilities" label="Responsibilities (1 ligne par item)" rows="4" auto-grow variant="outlined" density="compact" /></v-col>
          <v-col cols="12" md="4"><v-textarea v-model="form.profile" label="Profile (1 ligne par item)" rows="4" auto-grow variant="outlined" density="compact" /></v-col>
          <v-col cols="12" md="4"><v-textarea v-model="form.benefits" label="Benefits (1 ligne par item)" rows="4" auto-grow variant="outlined" density="compact" /></v-col>
        </v-row>
      </v-card-text>
