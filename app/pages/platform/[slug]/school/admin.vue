...
const homePath = computed(() => `/platform/${slug.value}/school/home`)
const adminPath = computed(() => `/platform/${slug.value}/school/admin`)
...
<template>
  <PlatformSplitLayout>
    ...
    <template #default>
      <UiSectionHeader
        title="Platform School Admin"
        :subtitle="`Zone d'administration pour l'application ${slug} sur School`"
      />
